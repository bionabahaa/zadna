...
$(document).on("click",".add-crepto",function(){
  $("#exampleModalLong").modal().show();
    ...
    $(document).on("click", "#saveMatrial", function () {
        ...
        var cul3 = '<td>' + $(".loc").val() + '</td>';
        var cul4 = '<td>' + $(".date ").val() + '</td>';
      
        var cul5 = "<td><i class='fas fa-times-circle' style='color: red'></i></td>";
    
        var cul6 = "<td class='query-td'><a href='maintenance-current-faults-view2.html'><i style='color: #212529 !important' class='fas fa-eye view-row' title='View'></i></a></td>\n";
