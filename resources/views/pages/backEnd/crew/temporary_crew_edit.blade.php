...
@section('page_content')
    ...
    font-size: 22px;"> المعلومات الشخصية</a>
                ...
                @if($healper->check_permission(25,6))
            ...
            font-size: 22px;">الملاحظات</a>
                ...
                @endif
                @if($healper->check_permission(25,7))
                ...
                <form id="EditCrewForm" method="post">
                    ...
                    <div class="row m-4 tab-top" >
                        <div class="col-lg-12 col-sm-12 col-12 ">
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table tableborder">
                                    ...
                                    <tr>
                                        ...
                                        <th scope="col">التكلفه الكليه </th>
                                    ...
                                    <tr>
                                        ...
                                        <td class="InputNum">
                                            <div class="form-group InputGroup">
                                                <input type="number" name="day_work_num" class="form-control numric td-edit" value="{{ @$crew->day_work_num}}">
                                            </div>
                                        ...
                                        <td class="InputNum">
                                            <div class="form-group InputGroup td-edit">
                                                <input type="number" name="total_cost" readonly class="form-control numric td-edit" min="0" value="{{@$crew->total_cost}}" >
                                            </div>
                                        </td>
                                ...
                                <table class="table tableborder">
                                    ...
                                    <tr>
                                        <td class="InputNum" style="width: 20%;">
                                            <input type="text" name="process" class="form-control numric td-edit" value="{{ @$crew->process}}"  >
                                            <div id="process_demo"></div>
                                        </td>

                                        <td class="InputNum">
                                            <div class="form-group InputGroup">
                                                <input type="text" name="phone" class="form-control numric td-edit" value="{{ @$crew->phone}}"  >
                                            </div>
                                        ...
                                        {{--<td class="InputNum">--}}
                                            {{--<select name="boxes[]" class="form-control select2 " multiple="multiple" style="width: 100%;">--}}
                                                {{--@foreach($boxes as $box)--}}
                                                    {{--<option value="{{$box->id}}" @if(in_array($box->id,$selected_boxes)) selected @endif >{{$box->code}}</option>--}}
                                                {{--@endforeach--}}
                            ...
                            @if($healper->check_permission(25,8))
                                @if($user->blocked==0)
                                ...
                                @endif
                            @endif
                            @if($healper->check_permission(25,5))
                             <button type="button" class="btn edit-btn" style=" background-color:#d8d612;" id="SubmitButton_edit_temporary_user">تعديل</button>
                            @endif
                                    ...
                                    <table class="table zadnatable mainTable notesTable" tableId="11" id="Crew_noteDataTable " width="100%">
                                        ...
                                        @if(!empty($user_notes))
                                            @foreach($user_notes as $user_note)
                                                ...
                                                <td>
                                                    <i class="fa fa-eye" data-target="#addNotesModal" data-toggle="modal" onclick="editNote({{$user_note->id}})"></i>
                                                </td>
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="row mb-4">
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <input type="text" id="descrep" value="{{auth()->user()->username}}" disabled  name="added_from" class="border-style col-6 col-val">
