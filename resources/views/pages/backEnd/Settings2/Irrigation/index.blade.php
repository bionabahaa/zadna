            ...
            <div col-lg-3>
                ...
                <div class="button-cont">
                    <form id="form_upload" method="post" enctype="multipart/form-data">
                        ...
                        <input  type="file" name="file" id="file-1" class="inputfile inputfile-1 upload" data-multiple-caption="{count} files selected"
                             />
            ...
            <div class="Tparent">
                ...
                <div class="row m-4">
                    ...
                    <div class="float-left ">
                        ...
                        <button class="add-crepto mr-2 mb-2 addNewRow " onclick="window.location.href='{{route('irrigation.create')}}'">أضافة خط</button>
