...
font-size: 22px;">المواصفات العامة</a>
            ...
            {{-- <li class="nav-item ">
                <a class="nav-link  linkColor " id="maintain-tab" data-toggle="tab" href="#maintain" role="tab" aria-controls="Gdetails"
                    aria-selected="true" style="border: none;
padding: 4px;
font-size: 22px;">الصيانه الدورية</a>
            </li>
            ...
            <li class="nav-item ">
                <a class="nav-link linkColor " id="techni-tab" data-toggle="tab" href="#techni" role="tab" aria-controls="water" aria-selected="false"
                    style="border: none;
padding: 4px;
font-size: 22px;">المواصفات الفنيه</a>
            </li> --}}
        </ul>
                ...
                <div class="weels m-5">
                    <div class="row p-4 m-2">
                        ...
                        <div class="col-md-3 col-xs-12">
                            ...
                            <hr>
                            <div class="form-group InputGroup">
                                <input type="text" name="title" class="form-control numric">
                    ...
                    <div class="row p-4 m-2">
                        <div class="col-md-3 col-xs-12">
                            ...
                            <hr>
                            <div class="form-group InputGroup">
                                <input type="number" name="config[locations]" class="form-control numric">
                        ...
                        <div class="col-md-3 col-xs-12">
                            ...
                            <hr>
                            <div class="form-group InputGroup">
                                <input type="text" name="config[depth]" class="form-control numric">
                        ...
                        <div class="col-md-3 col-xs-12">
                            ...
                            <hr>
                            <div class="form-group InputGroup">
                                <input type="text" name="config[cost]" class="form-control numric">
                    ...
                    <div class="row p-4 m-2">
                        <div class="col-md-6 col-xs-12">
                            ...
                            <hr>
                            <div class="form-group InputGroup">
                                <input type="text" class="form-control numric" name="config[minimum_water_quantity]" id="well-lowest-amount-of-water">
