                ...
                <div class="weels m-5">
                    <div class="row p-4 m-2">
                        <div class="col-md-3 col-xs-12">
                            ...
                            <div class="form-group InputGroup">
                                    <select class="form-control numric" name="farm_id">
                        ...
                        <div class="col-md-3 col-xs-12">
                            ...
                            <hr>
                            <div class="form-group InputGroup">
                                <input type="text" value="{{ $info->title }}" name="title" class="form-control numric">
                        ...
                        <div class="col-md-3 col-xs-12">
                            ...
                            <div class="form-group InputGroup">
                                <select class="form-control filter-form" name="status">
                                    ...
                                    <option value="{{ $key }}" @if($info->status==$key) selected="true" @endif>{{ $value }}</option>
                                    @endforeach
                    ...
                    <div class="row p-4 m-2">
                        <div class="col-md-3 col-xs-12">
                            ...
                            <hr>
                            <div class="form-group InputGroup">
                                <input type="number" value="{{ $info->locations }}" name="config[locations]" class="form-control numric">
                        ...
                        <div class="col-md-3 col-xs-12">
                            ...
                            <hr>
                            <div class="form-group InputGroup">
                                <input type="text" value="{{ $info->depth }}" name="config[depth]" class="form-control numric">
                        ...
                        <div class="col-md-3 col-xs-12">
                            ...
                            <!--                ذودت قطر البئر-->
                            <div class="form-group InputGroup">
                                <input type="text" value="{{ $info->well_radius }}" name="config[well_radius]" class="form-control numric">
                        ...
                        <div class="col-md-3 col-xs-12">
                            ...
                            <hr>
                            <div class="form-group InputGroup">
                                <input type="text" value="{{ $info->cost }}" name="config[cost]" class="form-control numric">
                    ...
                    <div class="row p-4 m-2">
                        <div class="col-md-6 col-xs-12">
                            ...
                            <hr>
                            <div class="form-group InputGroup">
                                <input type="text" class="form-control numric" value="{{ $info->minimum_water_quantity }}" name="config[minimum_water_quantity]" id="well-lowest-amount-of-water">
                        ...
                        <div class="col-md-6 col-xs-12">
                            ...
                            <div class="button-cont">
                                ...
                                <a href="{{ $info->geological_profile_file }}"> الملف </a>
                    ...
                    <div class="row p-4 m-2">
                        <div class="col-md-6 col-xs-12">
                            ...
                            <hr>
                            <div class="form-group InputGroup">
                                <input type="text" name="config[note]" value="{{ $info->note }}" class="form-control numric">
